...
<section class="purchase-now customHiddenSubscribeBar" style="    padding-bottom: 0;    padding-top: 0;    background: black;">
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                <div class="col-md-9">
                ...
                <div class="col-md-3">
                    <a href="#" class="btn btn-primary custom-button red-btn btn-xm">Suscríbete</a>
                </div>
            </div>
...
<section class="about-us" id="aboutus3">
    <div class="container">
        <div class="row">
            <div class="col-lg-5 col-md-5 column">
                <div class="big-intro wow fadeInLeft animated" data-wow-offset="30" data-wow-duration="1.5s" data-wow-delay="0.15s">
...
<section class="purchase-now" style="    padding-bottom: 0;    padding-top: 0;    background: #db5a4a;">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
...
<section class="about-us" id="aboutus4">
    <div class="container">
        <div class="section-header">
            <h6 class="white-text">
                ¿Porque unirse a la
            </h6>
            <h2 class="white-text" style="color: #db5a4a;">#COMUNIDAD SOCIAL?</h2>
